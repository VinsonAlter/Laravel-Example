...
@section('container')
        ...
        <form method="post" action="/dashboard/posts/{{$post->slug}}" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" 
                ...
                <!-- if not old then use $post->title instead , if user update new title then will update according to old
            ...
            <div class="mb-3">
              ...
              <!-- Overlay duplicate images when user uploaded -->
    ...
    <script>
      ...
      /* disable file upload function at trix editor */
